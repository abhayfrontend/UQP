...
@Component({
  selector: 'app-mra-productivity',
  templateUrl: './mra-productivity.component.html',
  styleUrls: ['./mra-productivity.component.scss']
})
export class MraProductivityComponent implements OnInit {
...
this.params.teamid=null;
  ...
  getReport(type) {
    ...
    // console.log(obj)/
    this.commonService.getAssuranceProductivity(this.params,"MRA"
    ).subscribe(results => {
